      ...
      <section className="instruction">
        <div className="instructionWrap">
          ...
          <p>
            ...
            prend en compte les aménagements mis à la disposition des touristes.
          </p>
          <p>
            La clientèle étant de plus en plus exigeante par rapport au respect
            de l’environnement, l’enjeu de cette charte est de faire prendre
          ...
          <p>
            {" "}
            Pour chaque critère étudié, il faudra déterminer s'il est applicable
            à votre activité ou non. S'il n'est pas applicable, cochez la case
          ...
          <ul className="listCriteria">
            <li>
              ...
              validés. Ce sont des prérequis, ils ne rapportent donc pas de
            ...
            <li>
              ...
              considérée comme Eco-Tourisme, il faudra valider au moins 80% du
              total de ces critères arrondis à l’unité supérieure, complétés si
              besoin par les critères optionnels validés.
            </li>
            <li>
              {" "}
              Les critères optionnels concernent en partie des aménagements qui
              sont plus contraignants ou coûteux à mettre en place, ils ne
          ...
          <button type="button">
            <Link to="/formulaire-1">Commencer </Link>
          </button>
        </div>
      </section>
      <FooterUser />
