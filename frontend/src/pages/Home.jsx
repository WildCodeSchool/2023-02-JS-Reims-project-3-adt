    ...
    <div className="home">
      ...
      <div className="instruction">
        ...
        <p>
          ...
          long terme, de réduire son coût de fonctionnement de façon durable.
        </p>
        ...
        <ul className="listCriteria">
          ...
          <li>
            ...
            sont plus contraignants ou coûteux à mettre en place, ils ne peuvent
            donc pas être imposés mais sont tout de même valorisés s’ils sont
            validés. Ils sont à considérer comme des pistes d’amélioration dans
